...
Provides:       golang(%{import_path}/cmp) = %{version}-%{release}
Provides:       golang(%{import_path}/cmp/cmpopts) = %{version}-%{release}
...
%gotest %{import_path}/cmp
%gotest %{import_path}/cmp/cmpopts
%gotest %{import_path}/cmp/internal/diff
%gotest %{import_path}/cmp/internal/value
%endif
